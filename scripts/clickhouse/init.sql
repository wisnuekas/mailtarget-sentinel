-- Local dev schema for Mailtarget Sentinel
-- Matches event-clickhouse-ddl.sql (production reference)
...
(
    ...
    recipient_meta Map(String, String),
    ...
    user_agent_parsed Map(String, String)
)
ENGINE = ReplacingMergeTree
PRIMARY KEY (injection_time, type, bounce_classification_code, company_id, ip_pool, sub_account_id, reason, recipient_domain, event_id)
ORDER BY (injection_time, type, bounce_classification_code, company_id, ip_pool, sub_account_id, reason, recipient_domain, event_id)
